class Spree::Blog::Admin::PostProductsController < Spree::Admin::BaseController
  ...
  def create
    ...
    render :partial => "spree/blog/admin/post_products/related_products_table", :locals => { :post => @post }, :layout => false
  end
